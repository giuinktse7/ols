...
| [`feat/declaration-theming`](https://github.com/giuinktse7/ols/tree/feat/declaration-theming) | Marks declared symbols with the semantic-token `declaration` modifier and expands VS Code syntax scopes so themes can distinguish declarations, declaration operators, directives, and related language constructs. |
